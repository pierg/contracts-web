            ...
            <div className="w-full md:w-8/12 px-4">
              <ul className="flex flex-wrap list-none md:justify-end justify-center">
                ...
                <li>
                  ...
                  >
                    {" "}
                    {customfooter.publications.title}{" "}
                  </button>
                </li>
                <li>
                  <button
              ...
              >
                <ModalBody>
                  <div className="modal-header justify-content-center font-bold text-2xl uppercase text-blueGray-700">
                    {customfooter.publications.title}
                  </div>
              ...
              >
                <ModalBody>
                  ...
                  <p className="modal-body text-justify font-medium text-lg">
                    {customfooter.aboutUs.text}
                  </p>
                </ModalBody>
              </Modal>
            </div>
